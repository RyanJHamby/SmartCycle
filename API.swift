  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateRpi1: GraphQLSelectionSet {
      ...
      public static let selections: [GraphQLSelection] = [
        ...
        GraphQLField("random_string", type: .nonNull(.scalar(String.self))),
        GraphQLField("random_number", type: .nonNull(.scalar(Int.self))),
      ]
      ...
      public init(macId: String, ts: Int, randomString: String, randomNumber: Int) {
        self.init(snapshot: ["__typename": "Rpi1", "mac_Id": macId, "ts": ts, "random_string": randomString, "random_number": randomNumber])
      }
      ...
      public var randomString: String {
        get {
          return snapshot["random_string"]! as! String
        }
        set {
          snapshot.updateValue(newValue, forKey: "random_string")
        }
      }

      public var randomNumber: Int {
        get {
          return snapshot["random_number"]! as! Int
        }
        set {
          snapshot.updateValue(newValue, forKey: "random_number")
        }
      }
    }
  }
...
public final class GetRpi1Query: GraphQLQuery {
  public static let operationString =
    "query GetRpi1($mac_Id: String!) {\n  getRpi1(mac_Id: $mac_Id) {\n    __typename\n    mac_Id\n    ts\n    random_string\n    random_number\n  }\n}"

  public var mac_Id: String

  public init(mac_Id: String) {
    self.mac_Id = mac_Id
  }

  public var variables: GraphQLMap? {
    return ["mac_Id": mac_Id]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("getRpi1", arguments: ["mac_Id": GraphQLVariable("mac_Id")], type: .object(GetRpi1.selections)),
    ]
